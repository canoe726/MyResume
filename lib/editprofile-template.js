...
module.exports = {
    ...
    LOGOUT_HEADER: function() {
        ...
        <header class="desktop-header">
            <div>
                <a class="menu-btn" href="/" onclick="return redirectConfirm(this)">홈</a>
                <a class="menu-btn" href="/myprofile" onclick="return redirectConfirm(this)">내 프로필</a>
                <a class="menu-btn active" href="/editprofile" onclick="return redirectConfirm(this)">프로필 수정</a>
                <a class="menu-btn" href="/todolist" onclick="return redirectConfirm(this)">To Do 리스트</a>
                <a class="menu-btn" href="/sample" onclick="return redirectConfirm(this)">샘플</a>
                <a class="login-btn" href="/logout" onclick="return redirectConfirm(this)">로그아웃</a>
            </div>
        </header>
    ...
    if(data.user_info != undefined) {
        ...
        <ul class="contact-list">
            <li>
                ...
                <input type="tel" name="user_info_phone" placeholder="01012345678" pattern="[0-9]{3}[0-9]{4}[0-9]{4}" value="${sanitizeHtml(data.user_info.phone)}">
            </li>
            <li>
        ...
        <ul class="contact-list">
            <li>
                <i class="fas fa-mobile-alt"></i>
                <input type="tel" name="user_info_phone" placeholder="01012345678" pattern="[0-9]{3}[0-9]{4}[0-9]{4}" value="">
            </li>
            <li>
                <i class="fas fa-envelope-square"></i>
...
function editHighSchool(data) {
    ...
    if(data.activate.high_school != null) {
        ...
        for(var i=0; i<keywords.length; i++) {
            html += `
            <div class="keyword col-12 col-md-6 col-xl-4">
