        ...
        <section class="login-section">
            <div class="row">
                ...
                <form action="./register/user_register" method="post">
                    <table>
                        <tr>
                            <td class="caption"> 아이디 (이메일 형식)</td>
                            <td><input type="email" name="user_email" size="50" check_result="fail" placeholder="abcde@email.com"></td>
                            <td>
                        ...
                        <tr>
                            <td class="caption"> 비밀번호 (최소 8자)</td>
                            <td><input type="password" name="user_pw" size="50" minlength="8"></td>
                        </tr>
                        <tr>
                            <td class="caption"> 닉네임 (최대 15자)</td>
                            <td><input type="text" name="user_nickname" check_result="fail" size="50" maxlength="15"></td>
                            <td>
